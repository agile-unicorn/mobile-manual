...
Storys (blau) haben einen Wert zwischen 3 und 20 Siegpunkten (3, 8, 13, 20). Er entspricht der Zahl oben links auf der Karte.
...
Incentives (grün) können nach dem Würfeln eingesetzt werden, um das Ergebnis zu verbessern.
...
!!! warning "Wichtig"
    Wer kein Teammitglied im Pitch-Duell eingesetzt hat, kann keine Event-Karten einsetzen. Sobald ein Spieler eine neue Event-Karte ausgespielt hat, kann jeder andere Spieler im Pitch reagieren und weitere eigene Event-Karten legen.

## Symbole

| Effekt            | Symbol                                                | Beschreibung                                                                                                                                                                                                                                                                                                                                         |
|-------------------|-------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Punktwert         | ![Plus one symbol](images/plus1.png)                  | Bonus oder Malus auf das gewürfelte Ergebnis.                                                                                                                                                                                                                                                                                                        |
| Aussetzen         | ![Aussetzen symbol](images/skip.png)                  | Der Spieler muss alle gelegten Teamkarten sofort wieder auf die Hand nehmen. Die Teamkarten können im nächsten Pitch weiter verwendet werden, aber gespielte Event-Karten sind verloren. Es können Event-Karten gespielt werden, die auf der Hand sind (z.B. Zauberstab oder "Teammitglied dazu", um einzelne Teammitglieder doch noch einzusetzen). |
| Zauberstab        | ![Magic wand symbol](images/wand.png)                 | Unmittelbarer Aufhebe-Effekt. Wendet einmalig die Auswirkung einer anderen zuvor gespielten Event-Karte ab. Die Karte kann auch gegen andere Zauberstab-Karten gespielt werden,.                                                                                                                                                                     |
| Würfel            | ![Dice symbol](images/minusdice.png)                  | Einmalig die gezeigten Würfel zusätzlich oder weniger im Pitch.                                                                                                                                                                                                                                                                                      |
| Teammitglied dazu | ![Teammitglied dazu Symbol](images/plusdev.png)       | Der adressierte Spieler muss eine zusätzliche Teamkarte im Pitch verwenden. Diese Karte muss von seiner Hand kommen und wird von ihm selbst ausgewählt. Hat der Spieler keine Teamkarte mehr auf der Hand, verfällt der Effekt.                                                                                                                                                                                             |
| Teammitglied weg  | ![Teammitglied entfernen Symbol](images/minusdev.png) | Der adressierte Spieler muss eine bereits gespielte Teamkarte seiner Wahl aus dem Pitch entfernen. Diese Teamkarte darf erst wieder im nächsten Sprint auf die Hand genommen werden.   Es können Event-Karten gespielt werden, die auf der Hand sind (z.B. Zauberstab oder "Teammitglied dazunachziehen", um einzelne Teammitglieder doch noch einzusetzen).                                                                                                                                                              
